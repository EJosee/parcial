...
<head>
	...
	<title>Beckenbauer/Tacon Narrow</title>
</head>
		...
		<div class="modal fade" id="vis2">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="row">
							<div class="col-md-5">
								<img class="img-responsive" src="imgs/p-narrow/02.jpg" alt="">
							</div>
							<div class="col-md-5">
								<strong><p>Detalles</p></strong>
									<li class="glyphicon " aria-hidden="true"> </li>
		...
		<div class="modal fade" id="vis4">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="row">
							<div class="col-md-5">
								<img class="img-responsive" src="imgs/p-narrow/04.jpg" alt="">
							</div>
							<div class="col-md-5">
								<strong><p>Detalles</p></strong>
									<li class="glyphicon " aria-hidden="true"> </li>
		...
		<div class="modal fade" id="vis6">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="row">
							<div class="col-md-5">
								<img class="img-responsive" src="imgs/p-narrow/06.jpg" alt="">
							</div>
							<div class="col-md-5">
								<strong><p>Detalles</p></strong>
									<li class="glyphicon " aria-hidden="true"> </li>
