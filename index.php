...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
			<img class="img-responsive" src="imgs/im.png" alt="">
        ...
        <div class="well">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a class="btn btn-lg btn-default btn-block" data-toggle="modal" data-target="#contac">Contactanos</a>
                </div>
            </div>
        </div>
		<!-- Section end-->
